...
from shire.bayes_net import CartPoleBayesNet
from shire.intuition import observation_to_state
...
class SHIREPPO(PPO):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.shire_coef = shire_coef

        self.bayes_net = CartPoleBayesNet()

    def compute_intuition_loss(
            self,
            observations,
            policy_distribution
    ):
        ...
        for obs, ppo_prob in zip(
                observations,
                probs
        ):
            angle_state, vel_state = (
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                # zmodyfikowano – start
                loss = policy_loss + self.ent_coef * entropy_loss + self.vf_coef * value_loss + self.shire_coef * intuition_loss
                # zmodyfikowano – koniec
